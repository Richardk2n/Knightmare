...
public class NormalMappingShader extends ShaderProgram {
	...
	private static final String VERTEX_FILE = "/shaders/NormalMappedEntityVertexShader.txt", FRAGMENT_FILE = "/shaders/NormalMappedEntityFragmentShader.txt";

	private int location_transformationMatrix, location_projectionMatrix, location_viewMatrix, location_lightPositionEyeSpace[], location_lightColour[],
			location_attenuation[], location_shineDamper, location_reflectivity, location_skyColour, location_numberOfRows, location_offset, location_plane,
			location_modelTexture, location_normalMap;
