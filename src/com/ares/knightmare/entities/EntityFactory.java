...
public class EntityFactory {
	...
	public static Entity createEntity(Loader loader, String modelName, String textureName,boolean hasTransparency, Vector3f position, Vector3f rotation, int scale, int shineDampener,
			int reflectivity) {
		TexturedModel texturedModel = new TexturedModel(OBJLoader.loadObjModel(modelName, loader), new ModelTexture(loader.loadTexture(textureName)));
	...
	public static Entity createEntity(Loader loader, String modelName, String textureName,boolean hasTransparency, Vector3f position, Vector3f rotation, int scale, int shineDampener,
			int reflectivity, int rowCount, int textureId) {
		TexturedModel texturedModel = new TexturedModel(OBJLoader.loadObjModel(modelName, loader), new ModelTexture(loader.loadTexture(textureName)));
		ModelTexture texture = texturedModel.getTexture();
